...
export default function TradeSquareFinal() {
  ...
  const [status, setStatus] = useState<
    "idle" | "loading" | "success" | "already_joined" | "error"
  >("idle");
  ...
  return (
    <div
      className="min-h-screen flex flex-col md:flex-row font-sans relative"
            ...
            >
              ...
              <p className="mb-8" style={{ color: "#6B7280" }}>
                {status === "success" ? (
                  <div>
                    <p>
                      We've added your email to our early access list. We'll be
                      in touch soon!
                    </p>
                    <p className="font-bold mt-4">In the main time kindly Join our community</p>
                    <a href="https://chat.whatsapp.com/FRAeyy4xFtx6ay7U0lbWUB" target="_blank" rel="noopener noreferrer">
                      <button
                        className="mt-4 px-6 py-3 flex gap-4 items-center justify-center rounded-lg font-bold text-white transition-all active:scale-95 mx-auto"
                  ...
                  <div>
                    <p>
                      You're already on the list! We love the enthusiasm—hang
                      tight for our launch.
                    </p>
                  </div>
                )}
              </p>
{/* 
      ...
      {/* Hero Sidebar */}
      <aside
        className="w-full md:w-1/3 p-8 md:p-12 flex flex-col justify-between text-white relative overflow-hidden"
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6 mt-12">
            <div className="flex items-start gap-4">
              ...
              <p className="text-sm opacity-80" style={{ color: "#E5E7EB" }}>
                Instant campus-wide reach for your listings.
              </p>
            </div>
            <div className="flex items-start gap-4">
              <div className="mt-1" style={{ color: "#22C55E" }}>
              ...
              <p className="text-sm opacity-80" style={{ color: "#E5E7EB" }}>
                Verified student profiles for safe trading.
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="flex-1 flex flex-col p-8 md:p-24 relative">
        ...
        <section className="max-w-xl">
          <h1
            className="text-5xl md:text-6xl font-black mb-8 leading-[1.1]"
            style={{ color: "#0F172A" }}
          >
          ...
          <p
            ...
            style={{ color: "#6B7280" }}
          >
            Stop wasting time on sketchy group chats. Join the waitlist for the
            only marketplace officially designed for Nigerian campus life.
          </p>

          <form
            onSubmit={handleSubmit}
            className="p-1 rounded-2xl bg-white shadow-xl border flex flex-col md:flex-row gap-2"
        ...
        <footer
          className="mt-auto pt-12 flex justify-between items-center border-t"
          style={{ borderColor: "#E5E7EB" }}
        >
          <p className="text-xs font-semibold" style={{ color: "#6B7280" }}>
            &copy; 2026 TRADESQUARE NOVA
          </p>
        </footer>
      </main>
    </div>
